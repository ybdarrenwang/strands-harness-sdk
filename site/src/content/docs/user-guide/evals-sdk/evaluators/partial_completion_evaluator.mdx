...
- **Session-Level Evaluation**: Evaluates the full conversation trace to assess progress across all task sub-steps
...
This evaluator operates at the **SESSION_LEVEL**, evaluating the full conversation trace to assess progress across all task sub-steps.
